...
if(isset($_POST['submit']))
{
    ...
    $sql5 = "SELECT * FROM tbl_cart WHERE title='$title'" ;
    ...
    if($count5 > 0)
    {
        echo '<script>alert("Product has been already added to cart.")</script>' ;
    }
    else
    {
            ...
            if($res4==TRUE)
            {
                echo '<script>alert("Product is successfully added to cart.")</script>' ;
            }
