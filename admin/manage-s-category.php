                                            ...
                                            <div class="modal fade" id="a<?php echo $id; ?>" tabindex="-1" aria-labelledby="a<?php echo $id; ?>Label" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <a href="<?php echo SITEURL ;?>admin/delete-s-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>"><button class="btn btn-sm btn-outline-danger">CONFIRM</button></a>
